...
public class TradingController {
    ...
    public String myView(@RequestParam String symbol) throws IOException {
        return myViewService.analyzeMarkdown(symbol);
    }



    @GetMapping("/api/trading/my-view-json")
    public MyViewJsonReport myViewJson(@RequestParam String symbol) throws IOException {
        return myViewService.analyzeJson(symbol);
    }

    @GetMapping("/api/trading/review-view")
    public String reviewView(@RequestParam String symbol) throws IOException {
        return reviewInsightService.analyzeMarkdown(symbol);
    }
